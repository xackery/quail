...
func (e *WldFragRegion) Parents() []common.TreeLinker {
	return e.parents
}

func (e *WldFragRegion) AddParent(parent common.TreeLinker) {
	e.parents = append(e.parents, parent)
}

func (e *WldFragRegion) Tag() string {
	return e.tag
}

func (e *WldFragRegion) SetFragID(id int) {
	e.fragID = id
}

func (e *WldFragRegion) FragID() int {
	return e.fragID
}

func (e *WldFragRegion) Children() []common.TreeLinker {
	return nil
}

func (e *WldFragRegion) FragType() string {
	return "REGD"
}

func (e *WldFragRegion) AddChild(child common.TreeLinker) {
