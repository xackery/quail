...
func (e *WLD) VertexAdd(position *math32.Vector3, normal *math32.Vector3, tint *common.Tint, uv *math32.Vector2, uv2 *math32.Vector2) error {
...
func (e *WLD) FaceAdd(index [3]uint32, materialName string, flag uint32) error {
